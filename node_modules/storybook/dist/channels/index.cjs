...
t Symbol]")
    ...
    "node_modules/.pnpm/get-intrinsic@1.3.0/node_modules/get-intrinsic/index.js"(t, e) {
      ...
      w = ur(), A = dr(), L = Function, I = /* @__PURE__ */ s(function(O) {
        try {
      ...
      }() : ge, D = et()(), E = _r(), Ot = rt(), Pt = tt(), Fe = nt(), K = Te(), $ = {}, Ct = typeof Uint8Array > "u" || !E ? r : E(Uint8Array),
      R = {
        __proto__: null,
      ...
      if (E)
        try {
          ...
          Me = E(E(O)), R["%Error.prototype%"] = Me;
        }
      var Me, Nt = /* @__PURE__ */ s(function O(m) {
        var b;
        if (m === "%AsyncFunction%")
          b = I("async function () {}");
          ...
          var v = O("%AsyncGeneratorFunction%");
          v && (b = v.prototype);
      ...
      Dt = /\\(\\)?/g, $t = /* @__PURE__ */ s(function(m) {
        ...
        var S = [];
        return Ge(m, Lt, function(P, F, T, ae) {
          S[S.length] = T ? Ge(ae, Dt, "$1") : F || P;
        }), S;
      }, "stringToPath3"), Ft = /* @__PURE__ */ s(function(m, b) {
        var v = m, S;
        if (se(Ue, v) && (S = Ue[v], v = "%" + S[0] + "%"), se(R, v)) {
          var P = R[v];
          if (P === $ && (P = Nt(v)), typeof P > "u" && !b)
      ...
      e.exports = /* @__PURE__ */ s(function(m, b) {
        ...
        var v = $t(m), S = v.length > 0 ? v[0] : "", P = Ft("%" + S + "%", b), F = P.name, T = P.value, ae = !1, me = P.alias;
  ...
  Et.exports = Zt(at);
  var wr = _e(it()), Or = _e(Tr()), Pr = _e(xr());
  function Cr(t) {
  ...
  s(Kr, "arrayMap");
  var Xr = Kr, Qr = Array.isArray, Oe = Qr, Zr = 1 / 0, Ve = G ? G.prototype : void 0, Je = Ve ? Ve.toString : void 0;
  function lt(t) {
    if (typeof t == "string")
      return t;
    if (Oe(t))
  ...
  q.prototype.has = Ao;
  q.prototype.set = wo;
  var dt = q, Oo = "Expected a function";
  function Pe(t, e) {
    ...
    return r.cache = new (Pe.Cache || dt)(), r;
  }
  s(Pe, "memoize");
  Pe.Cache = dt;
  var Po = Pe, Co = 500;
  ...
  var Fo = $o;
  function Mo(t, e) {
    return Oe(t) ? t : jn(t, e) ? [t] : Do(Fo(t));
  }
  s(Mo, "castPath");
  var Uo = Mo, Go = 1 / 0;
  function ko(t) {
...
qt(ps, {
  ...
  createBrowserChannel: () => as,
  default: () => is
});
module.exports = Bt(ps);
...
// src/channels/index.ts
var { CHANNEL_OPTIONS: os, CONFIG_TYPE: ss } = At.global, is = U;
function as({ page: t, extraTransports: e = [] }) {
  let r = [new H({ page: t }), ...e];
  if (ss === "DEVELOPMENT") {
    let o = window.location.protocol === "http:" ? "ws" : "wss", { hostname: p, port: a } = window.location, { wsToken: c } = os || {}, i = `${o}\
://${p}:${a}/storybook-server-channel?token=${c}`;
    r.push(new J({ url: i, onError: /* @__PURE__ */ s(() => {
    }, "onError"), page: t }));
  }
