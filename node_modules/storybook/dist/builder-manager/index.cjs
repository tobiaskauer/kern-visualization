...
luckThirdPartyPackageFromPath"), be = /* @__PURE__ */ o(async (e) => {
  let i = {}, { builder: t, channelOptions: r } = await e.presets.apply("core"), a = await (0, J.getFrameworkName)(e), n = await (0, J.extractProperRendererNameFromFramework)(
  a);
  e.configType === "DEVELOPMENT" && (i.CHANNEL_OPTIONS = { wsToken: r?.wsToken }), n && (i.STORYBOOK_RENDERER = await (0, J.extractProperRendererNameFromFramework)(
  a) ?? void 0);
  let s = Dt(t);
  s && (i.STORYBOOK_BUILDER = Ui(s) ?? Gi(s));
  let l = Dt(await e.presets.apply("framework"));
  return l && (i.STORYBOOK_FRAMEWORK = l), i;
