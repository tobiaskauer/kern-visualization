...
kThirdPartyPackageFromPath"), me = /* @__PURE__ */ o(async (e) => {
  let i = {}, { builder: t, channelOptions: r } = await e.presets.apply("core"), a = await Vi(e), n = await Ot(a);
  e.configType === "DEVELOPMENT" && (i.CHANNEL_OPTIONS = { wsToken: r?.wsToken }), n && (i.STORYBOOK_RENDERER = await Ot(a) ?? void 0);
  let s = Et(t);
  s && (i.STORYBOOK_BUILDER = Xi(s) ?? Ki(s));
  let l = Et(await e.presets.apply("framework"));
